...
public class TransactionAPITest {
    ...
    public void transactionCreation() throws Exception {
        ...
        RequestBuilder requestBuilder = post(url)
                .header("Authorization", "Bearer " + authenticationToken)
                .param("date", "2024-03-24T14:01:26.588Z")
                .param("quantity", "1")
                .param("amount", "10.1")
                .param("note", "TEST")
                .param("type", "OUT");
        this.mockMvc.perform(requestBuilder).andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$.transaction.date").value("2024-03-24T00:00:00.000+00:00"))
    ...
    public void transactionListing() throws Exception {
        ...
        this.mockMvc.perform(requestBuilder).andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$.transactionList[0].date").value("2024-03-24T00:00:00.000+00:00"))
    ...
    public void transactionEdit() throws Exception {
        ...
        RequestBuilder requestBuilder = patch(url)
                .header("Authorization", "Bearer " + authenticationToken)
                .param("date", "2024-04-24T14:01:26.588Z")
                .param("amount", "20.2")
                .param("note", "TEST 2")
                .param("quantity", "2")
                .param("type", "IN");
        this.mockMvc.perform(requestBuilder).andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$.transaction.date").value("2024-04-24T00:00:00.000+00:00"))
